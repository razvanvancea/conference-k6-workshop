...
const getBooksByIdTime = new Trend('getBooksByIdTime');
const booksRequestTime = new Trend('booksRequestTime');
...
export default function () {
  ...
  getBooksByIdTime.add(res3.timings.duration);
  booksRequestTime.add(res3.timings.sending);
